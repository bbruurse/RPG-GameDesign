...
public class hoMove : MonoBehaviour
{
    ...
    internal void CreateTween()
    {
        ...
        plugPath = new PlugVector3Path(wpPos, true);
        ...
        //create a new tween, move this gameobject on bezier curves with given arguments
        tween = HOTween.To(transform, speed, tParms);
    }
